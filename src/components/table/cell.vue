    ...
    <div :class="classes" ref="cell">
        ...
        <template v-if="renderType === 'normal'">
            <template v-if="column.tooltip">
                <Tooltip transfer :content="row[column.key]" :disabled="!showTooltip" :max-width="300" class="sw-table-cell-tooltip">
                    <span ref="content" @mouseenter="handleTooltipIn" @mouseleave="handleTooltipOut" class="sw-table-cell-tooltip-content">{{ row[column.key] }}</span>
                </Tooltip>
            </template>
