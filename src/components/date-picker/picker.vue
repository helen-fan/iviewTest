...
<script>
    ...
    const pickerPrefixCls = 'sw-picker';
    ...
    const pulseElement = (el) => {
        const pulseClass = 'sw-date-picker-btn-pulse';
        ...
        methods: {
            ...
            navigateDatePanel(direction, shift){
                ...
                if (shift){
                    ...
                    // pulse button
                    const button = this.$refs.drop.$el.querySelector(`.sw-date-picker-${position}-btn-arrow${double}`);
